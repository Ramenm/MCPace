...
test("schemas document runtimeType stateClass and effectClass", () => {
	...
	assert.deepEqual(policyProps.runtimeType.enum, [
		"stateless",
		"stateful",
		"external",
		"interactive",
	...
	for (const schema of [profileSchema, workerSchema]) {
		...
		assert.ok(
			schema.properties.stateClass.enum.includes("remote-session-stateful"),
		);
