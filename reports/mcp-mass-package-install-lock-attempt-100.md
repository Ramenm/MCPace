...
Generated: 2026-05-19T10:12:56.457Z
Status: **blocked**
Mode: live-npm-search-metadata

Packages: 100; high-risk: 47; install-lock ok: false; tarballs: 0.
...
- FAIL install-lock-resolution: npm install --package-lock-only resolved selected packages without scripts.

## Blockers

- install-lock-resolution: npm install --package-lock-only resolved selected packages without scripts.
